...
CREATE TABLE IF NOT EXISTS "sandbox"."tb_sand_group_base" (
  ...
  "parent_group" VARCHAR NULL REFERENCES "sandbox"."tb_sand_group_base"("group_id"),
  ...
  "upd_dttm" BIGINT,
  "is_deleted" BOOLEAN DEFAULT false NOT NULL,
  CONSTRAINT "tb_sand_group_base_pkey" PRIMARY KEY ("group_cat", "group_id")
);
...
CREATE TABLE IF NOT EXISTS "sandbox"."tb_sand_user_group" (
  ...
  "group_id" VARCHAR REFERENCES "sandbox"."tb_sand_group_base"("group_id"),
  ...
  "upd_dttm" BIGINT,
  "is_deleted" BOOLEAN DEFAULT false NOT NULL,
  CONSTRAINT "tb_sand_user_group_pkey" PRIMARY KEY ("user_id", "group_id")
);
