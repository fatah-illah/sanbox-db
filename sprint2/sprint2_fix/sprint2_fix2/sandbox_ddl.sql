...
CREATE TABLE IF NOT EXISTS "shared_profile"."tb_profile_dtls_edu" (
  ...
  "seq" VARCHAR,
  "type" VARCHAR REFERENCES "sandbox"."tb_sand_comm_code_dtls"("comm_code"),
...
CREATE TABLE IF NOT EXISTS "jobportal"."tb_jobp_skills_base" (
...
CREATE INDEX IF NOT EXISTS "tb_jobp_skills_base_upd_dttm_idx" ON "jobportal"."tb_jobp_skills_base"("upd_dttm");
...
CREATE TABLE IF NOT EXISTS "shared_profile"."tb_profile_dtls_skill" (
  "user_id" VARCHAR NOT NULL,
  "seq" VARCHAR,
  "skill_id" VARCHAR NOT NULL REFERENCES "jobportal"."tb_jobp_skills_base"("skill_id"),
  "skill_level" VARCHAR NOT NULL REFERENCES "sandbox"."tb_sand_comm_code_dtls"("comm_code"),
  "issuer" VARCHAR,
  "description" TEXT,
  "certificate" VARCHAR,
  "attr1" VARCHAR,
...
CREATE TABLE IF NOT EXISTS "sandbox"."tb_sand_group_base" (
  ...
  "parent_group" VARCHAR NULL REFERENCES "sandbox"."tb_sand_group_base"("group"),
...
CREATE TABLE IF NOT EXISTS "sandbox"."tb_sand_user_group" (
  ...
  "group" VARCHAR REFERENCES "sandbox"."tb_sand_group_base"("group"),
