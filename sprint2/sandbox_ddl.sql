...
CREATE INDEX "tb_sand_user_dtls_upd_dttm_idx" ON "tb_sand_user_dtls"("upd_dttm");

-- Profile details education table one-to-many
CREATE TABLE "tb_profile_dtls_edu" (
  "user_id" VARCHAR NOT NULL,
  "seq" VARCHAR,
  "type" VARCHAR REFERENCES "tb_sand_comm_code_dtls"("comm_code"),
...
CREATE INDEX "tb_profile_dtls_edu_upd_dttm_idx" ON "tb_profile_dtls_edu"("upd_dttm");

-- Profile details career table one-to-many
CREATE TABLE "tb_profile_dtls_career" (
  "user_id" VARCHAR NOT NULL,
...
CREATE INDEX "tb_profile_dtls_career_dttm_idx" ON "tb_profile_dtls_career"("upd_dttm");

-- Profile details languages & skills table one-to-many
CREATE TABLE "tb_profile_dtls_skill" (
  "user_id" VARCHAR NOT NULL,
  "seq" VARCHAR,
  "skill_id" VARCHAR NOT NULL REFERENCES "tb_jobp_skills_base"("skill_id")
  "skill_level" VARCHAR NOT NULL REFERENCES "tb_sand_comm_code_dtls"("comm_code"),
  "issuer" VARCHAR,
  "description" TEXT,
  "certificate" VARCHAR,
  "attr1" VARCHAR,
...
CREATE INDEX "tb_profile_dtls_skill_dttm_idx" ON "tb_profile_dtls_skill"("upd_dttm");
