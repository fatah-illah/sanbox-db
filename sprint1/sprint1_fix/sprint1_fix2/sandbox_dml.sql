-- Insert dummy data for "tb_sand_comm_code_base"
INSERT INTO "tb_sand_comm_code_base" ("code_type", "code_type_name", "is_active", "reg_by", "reg_dttm", "upd_by", "upd_dttm")
VALUES 
...
-- Insert dummy data for "tb_sand_comm_code_dtls"
INSERT INTO "tb_sand_comm_code_dtls" ("code_type", "comm_code", "comm_code_name", "order_index", "is_active", "reg_by", "reg_dttm", "upd_by", "upd_dttm")
VALUES 
-- User Status
...
-- tb_sand_user_base
INSERT INTO "tb_sand_user_base" 
(employee_id, username, personal_email, phone_number, password, user_status, activation_date, reg_by, reg_dttm)
VALUES 
...
-- tb_sand_user_dtls
INSERT INTO "tb_sand_user_dtls" 
(user_id, fullname, working_email, main_role, department, division, working_site, gender, joined_date, reg_by, reg_dttm)
VALUES 
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'jsmith'), 'John Smith', 'john.smith@company.com', 'SUPER_ADMIN', 'GDC_DEP', 'SFS_DIV', 'JKT', 'M', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'mjohnson'), 'Mary Johnson', 'mary.johnson@company.com', 'ADMIN_2', 'GDC_DEP', 'BSE_DIV', 'KRW', 'F', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'rlee'), 'Robert Lee', 'robert.lee@company.com', 'USER', 'LDC_DEP', 'SFA_DIV', 'CJ', 'M', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'izradum'), 'Izri Addum', 'izri.addm@company.com', 'USER', 'LDC_DEP', 'SFA_DIV, SFS_DIV', 'CJ', 'M', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP), 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP));

-- tb_sand_role_base
INSERT INTO "tb_sand_role_base" 
...
-- tb_sand_user_role
INSERT INTO "tb_sand_user_role" 
(user_id, role_id, is_primary, reg_by, reg_dttm)
VALUES 
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'jsmith'), 
 (SELECT role_id FROM "tb_sand_role_base" WHERE "role" = 'SUPER_ADMIN'), 
 true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'mjohnson'), 
 (SELECT role_id FROM "tb_sand_role_base" WHERE "role" = 'ADMIN_2'), 
 true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'rlee'), 
 (SELECT role_id FROM "tb_sand_role_base" WHERE "role" = 'USER'), 
 true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP));

-- tb_sand_group_category
INSERT INTO "tb_sand_group_category" 
...
-- tb_sand_group_base
INSERT INTO "tb_sand_group_base" 
...
-- tb_sand_user_group
INSERT INTO "tb_sand_user_group" 
...
-- tb_sand_menu_base
INSERT INTO "tb_sand_menu_base" 
(menu_name, menu_cat, description, path, parent_id, menu_level, order_index, reg_by, reg_dttm)
VALUES 
('Dashboard', 'user', 'Main Dashboard', '/dashboard', null, 1, 1, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
('User Management', 'user', 'User Management Section', '/users', null, 1, 2, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
('Roles', 'admin', 'Role Management', '/users/roles', (SELECT menu_id from "tb_sand_menu_base" WHERE menu_name = 'User Management'), 2, 1, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
('Groups', 'admin', 'Group Management', '/users/groups', (SELECT menu_id from "tb_sand_menu_base" WHERE menu_name = 'User Management'), 2, 2, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
('Role Permissions', 'admin', 'Role Permission Management', '/users/roles/permissions', (SELECT menu_id from "tb_sand_menu_base" WHERE menu_name = 'User Management'), 3, 1, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
('Group Categories', 'admin', 'Group Category Management', '/users/groups/categories', (SELECT menu_id from "tb_sand_menu_base" WHERE menu_name = 'User Management'), 3, 2, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP));

-- tb_sand_role_menu_accs
INSERT INTO "tb_sand_role_menu_accs" 
(role_id, menu_id, user_id, is_read, is_create, is_modify, is_delete, reg_by, reg_dttm)
VALUES 
((SELECT role_id FROM "tb_sand_role_base" WHERE "role" = 'USER'), 
(SELECT menu_id FROM "tb_sand_menu_base" WHERE menu_name = 'Dashboard' AND menu_cat = 'user'),
 NULL, true, true, true, true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT role_id FROM "tb_sand_role_base" WHERE "role" = 'ADMIN_2'), 
(SELECT menu_id FROM "tb_sand_menu_base" WHERE menu_name = 'User Management' AND menu_cat = 'user'),
 NULL, true, true, false, false, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT role_id FROM "tb_sand_role_base" WHERE "role" = 'SUPER_ADMIN'), 
(SELECT menu_id FROM "tb_sand_menu_base" WHERE menu_name = 'Roles' AND menu_cat = 'admin'),
 NULL, true, true, true, true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT role_id FROM "tb_sand_role_base" WHERE "role" = 'ADMIN_3'), 
(SELECT menu_id FROM "tb_sand_menu_base" WHERE menu_name = 'Group Categories' AND menu_cat = 'admin'),
(SELECT user_id FROM "tb_sand_user_base" WHERE username = 'izradum'), 
 true, true, true, true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP));

-- tb_sand_otp_base
INSERT INTO "tb_sand_otp_base" 
...
INSERT INTO "tb_sand_user_status_log" 
...
INSERT INTO "tb_sand_login_attempt" 
