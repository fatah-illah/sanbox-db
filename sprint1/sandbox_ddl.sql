...
CREATE TABLE "tb_sand_user_role" (
  "user_id" VARCHAR(20) REFERENCES "tb_sand_user_base"("user_id"),
  "role" VARCHAR(50) REFERENCES "tb_sand_role_base"("role"),
  "is_primary" BOOL DEFAULT false NOT NULL,
  "attr1" VARCHAR(200),
  "attr2" VARCHAR(200),
  "attr3" VARCHAR(200),
  ...
  "upd_dttm" BIGINT,
  "is_deleted" BOOL DEFAULT false NOT NULL,
  CONSTRAINT "tb_sand_user_role_pkey" PRIMARY KEY ("user_id", "role")
);
...
CREATE TABLE "tb_sand_role_menu_accs" (
  ...
  "upd_dttm" BIGINT,
  "is_deleted" BOOL DEFAULT false NOT NULL,
  CONSTRAINT "tb_sand_role_menu_accs_pkey" PRIMARY KEY ("role", "menu_id")
);
