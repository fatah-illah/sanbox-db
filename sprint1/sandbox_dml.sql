...
(user_id, "role", is_primary, reg_by, reg_dttm)
VALUES 
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'jsmith'), 
 'SUPER_ADMIN', true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'mjohnson'), 
 'ADMIN_2', true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
((SELECT user_id FROM "tb_sand_user_base" WHERE username = 'rlee'), 
 'USER', true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP));
...
("role", menu_id, user_id, can_read, can_create, can_modify, can_delete, reg_by, reg_dttm)
VALUES 
('USER', (SELECT menu_id FROM "tb_sand_menu_base" WHERE menu_name = 'Dashboard' AND menu_cat = 'user'),
 NULL, true, true, true, true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
('ADMIN_2', (SELECT menu_id FROM "tb_sand_menu_base" WHERE menu_name = 'User Management' AND menu_cat = 'user'),
 NULL, true, true, false, false, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP)),
 ('SUPER_ADMIN', (SELECT menu_id FROM "tb_sand_menu_base" WHERE menu_name = 'Roles' AND menu_cat = 'admin'),
 NULL, true, true, true, true, 'SYSTEM', EXTRACT(EPOCH FROM CURRENT_TIMESTAMP));
