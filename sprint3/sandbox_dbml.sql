...
Table tb_sand_comm_code_dtls {
  code_type varchar [pk, ref: > tb_sand_comm_code_base.code_type]
  comm_code varchar [pk, unique]
...
Table tb_sand_user_base {
  ...
  username varchar [unique, note: '(G-Portal ID) or (Min 5 chars, alphanumeric, no special chars)']
  personal_email varchar [unique, note: 'Personal/External email for OTP']
  phone_number varchar [unique]
  password varchar
  status varchar [not null, default: '02', ref: > tb_sand_comm_code_dtls.comm_code, note: 'FK to COMM_CODE: USER_STATUS']
...
Table tb_sand_user_dtls {
  ...
  birthdate bigint [note: 'new added']
  domicile varchar [note: 'new added']
  avtr_path text
...
// User details education table one-to-many
Table tb_sand_user_dtls_edu {
  seq bigserial [pk]
  user_id varchar [ref: > tb_sand_user_base.user_id]
  type varchar [ref: > tb_sand_comm_code_dtls.comm_code, note: 'Formal or Informal']
  ...
  Note: 'Contains detailed education of user information one-to-many'
}

// User details career table one-to-many
Table tb_sand_user_dtls_career {
  seq bigserial [pk]
  user_id varchar [ref: > tb_sand_user_base.user_id]
  company varchar
  position varchar
  employement_type varchar [ref: > tb_sand_comm_code_dtls.comm_code]
  responsibility text
  attr1 varchar [note: 'Additional properties']
  attr2 varchar
  attr3 varchar
  ...
  Note: 'Contains detailed career of user information one-to-many'
}

// User details languages & skills table one-to-many
Table tb_sand_user_dtls_skill {
  seq bigserial [pk]
  user_id varchar [ref: > tb_sand_user_base.user_id]
  skill_name varchar [note: 'include language']
  issuer varchar
  description text
  certificate varchar
  attr1 varchar [note: 'Additional properties']
  ...
  Note: 'Contains detailed languages & skills of user information one-to-many'
}
